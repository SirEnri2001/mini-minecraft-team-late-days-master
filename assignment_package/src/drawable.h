...
protected:
    ...
    GLuint m_bufUV;
    GLuint m_bufAggregate;  // used to store interleaving data
    GLuint m_bufaggregatefortransparent;


    bool m_idxGenerated; // Set to TRUE by generateIdx(), returned by bindIdx().
    bool m_idxGeneratedfortransparent;
    bool m_posGenerated;
    bool m_norGenerated;
    bool m_colGenerated;
    bool m_aggregateGenerated;
    bool m_aggregatedGeneratedfortransparent;
    bool hasUV = false;
...
public:
    Drawable(OpenGLContext* mp_context, bool hasUV = false);
    virtual ~Drawable();
    ...
    void generateIdx();
    void generateIdxfortransparent();
    void generatePos();
    void generateNor();
    void generateCol();
    void generateAggregate();
    void generateAggregatefortransparent();

    bool bindIdx();
    bool bindIdxfortransparent();
    bool bindPos();
    bool bindNor();
    bool bindCol();
    bool bindUV();
    bool bindAggregate();
    bool bindAggregatefortransparent();
