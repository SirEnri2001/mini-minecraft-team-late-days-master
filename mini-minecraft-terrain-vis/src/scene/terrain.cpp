...
Terrain::Terrain(OpenGLContext *context)
    : m_instancedDataNeedsGenerating(true), m_chunks(), m_generatedTerrain(), m_geomCube(context), mp_context(context)
{}
...
void Terrain::draw(int minX, int maxX, int minZ, int maxZ, ShaderProgram *shaderProgram) {
    ...
    if(m_instancedDataNeedsGenerating) {
        m_instancedDataNeedsGenerating = false;
